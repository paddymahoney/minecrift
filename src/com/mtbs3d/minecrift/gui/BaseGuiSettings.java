            ...
            if (System.currentTimeMillis() >= this.mouseStillTimeMs + delayMs)
            {
                ...
                if (var9 != null)
                {
                    ...
                    for (int var12 = 0; var12 < var11.length; ++var12)
                    {
                        ...
                        this.fontRendererObj.func_175063_a(var13, var5 + 5, var6 + 5 + var12 * 11, 14540253);  // drawStringWithShadow
                    }
                }
            }
        }
    ...
    protected GuiButton getSelectedButton(int var1, int var2)
    {
        for (int var3 = 0; var3 < this.buttonList.size(); ++var3)
        {
            if (this.buttonList.get(var3) instanceof GuiButtonEx)
            {
                ...
                //                          xPos                           yPos
                boolean var5 = var1 >= var4.getXPos() && var2 >= var4.getYPos() && var1 < var4.getXPos() + var4.getWidth() && var2 < var4.getYPos() + var4.getHeight();
