...
public class MCHydra extends BasePlugin implements IEyePositionProvider, IOrientationProvider, IBodyAimController, IEventListener {
    ...
    Vec3 leftEyePos;
    Vec3 rightEyePos;
    Vec3 origin = new Vec3(0, 0, 0);  //in meters, relative to hydra base station
                       ...
                       float worldYawOffsetDegrees, float worldPitchOffsetDegrees, float worldRollOffsetDegrees)
    {
        ...
        Vec3 raw = new Vec3(rawX, rawY, rawZ);
        ...
        Vec3 correctionToCentreEyePosition = new Vec3(hydraXOffset, hydraYOffset, hydraZOffset);
        ...
        if (resetOrigin)
        {
        	...
        	Vec3 neckModelToCentreEyePosition = new Vec3(0, vrSettings.neckBaseToEyeHeight, -vrSettings.eyeProtrusion);
        ...
        leftEyePos = new Vec3(headPos.xCoord, headPos.yCoord, headPos.zCoord);
        leftEyePos.xCoord -= (ipd / 2f);
        rightEyePos = new Vec3(headPos.xCoord, headPos.yCoord, headPos.zCoord);
